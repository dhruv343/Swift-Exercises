...
print("No it doesn't work as we have made the falcon a class of space ship not the fighter and the weapon property is of the child class not the parent.")
