...
var age = checkAge(stringAge: "20")
// No, the function can also return nil
print("Age: \(age!)")
...
func findCost(itemName: String) -> Double? {
    if stock[itemName] != 0 {
        return prices[itemName]
    }
    return nil
}
if let cost = findCost(itemName: "Apple") {
    print("Price of the product: \(cost)")
} else {
