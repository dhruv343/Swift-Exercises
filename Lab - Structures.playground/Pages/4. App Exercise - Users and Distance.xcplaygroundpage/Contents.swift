...
var Deepankar = User(name: "Deepankar", age: 20, height: 180.5, width: 34, activityLevel: 9)
Deepankar.printOut()
/*:
 ...
 */
struct Distance{
    var meters = Double.init()
    var feet = Double.init()
    init(meters: Double){
        self.meters=meters
        feet=3.28084 * meters
    }
...
var someMile=Distance(meters: 1000)
someMile.printOut()
